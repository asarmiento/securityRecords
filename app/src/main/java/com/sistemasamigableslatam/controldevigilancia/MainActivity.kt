...
Log.i("ubicación1: ","LATITUD = " + location.latitude.toString()+" LONGITUD = " + location.longitude.toString())
                    }
                }
            }
        } else {
    ...
    private val mLocationCallBack = object : LocationCallback(){
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            Log.i("ubicación2: ","LATITUD = " + mLastLocation.latitude.toString()+" LONGITUD = " + mLastLocation.longitude.toString())
        }
    }
